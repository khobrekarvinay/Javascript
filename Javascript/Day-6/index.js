...
console.log("Q4 Print numbers from 40 - 20 and with sequence for 3 ") 
...
console.log(" Q print numbers from 40 - 0 and who are odd . ") 
...
console.log("Q . Calculate total count of even and odd numbers from range 60 - 20") 
